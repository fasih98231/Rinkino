    ...
    <div className="space-y-6 animate-in fade-in duration-300">
                  ...
                  <div className="space-y-4 flex flex-col justify-between h-full">
                    ...
                    {isIssueNode && (
                      <button
                        ...
                        className="w-full py-2.5 mt-4 rounded-xl bg-lime-400 hover:bg-lime-300 text-black text-xs font-bold flex items-center justify-center gap-1.5 transition-all cursor-pointer disabled:opacity-50"
                      >
                        {isResolvingNode ? (
                          <>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-xs">
        ...
        <div className="p-4 rounded-xl bg-slate-900/40 border border-slate-800 flex items-center justify-between">
          ...
          <span className="px-2 py-0.5 rounded bg-lime-950 text-lime-400 border border-lime-900/40 font-mono text-[10px]">
            {mobileFriendliness.score}/100 Score
          </span>
        </div>
      </div>
    </div>
